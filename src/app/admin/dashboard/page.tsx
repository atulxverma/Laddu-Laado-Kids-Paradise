...
import { TrendingUp, ShoppingBag, AlertTriangle, PackageCheck, ArrowRight, Activity } from "lucide-react"
    ...
    <div className="min-h-screen space-y-10 bg-neutral-50 p-6 md:p-10">
      <div className="pt-8 md:pt-0 flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Link href="/admin/products" className="bg-white border border-gray-200 text-black px-5 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-gray-50 transition-all">
            Add Product
          </Link>
          <Link href="/" className="bg-black text-white px-5 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest hover:opacity-80 transition-all">
            View Store
          </Link>
        </div>
      </div>
