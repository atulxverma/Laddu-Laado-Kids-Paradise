      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-wrap gap-3 mb-10">
          <Link
            ...
            className={`px-5 py-3 rounded-full text-[10px] font-black uppercase tracking-widest transition-all ${gender === "Newborn"
              ? "bg-black text-white"
          ...
          <Link
            ...
            className={`px-5 py-3 rounded-full text-[10px] font-black uppercase tracking-widest transition-all ${gender === "Boy"
              ? "bg-black text-white"
              : "bg-gray-100 text-gray-500"
              }`}
          >
          ...
          <Link
            ...
            className={`px-5 py-3 rounded-full text-[10px] font-black uppercase tracking-widest transition-all ${gender === "Girl"
              ? "bg-black text-white"
              : "bg-gray-100 text-gray-500"
              }`}
          >
