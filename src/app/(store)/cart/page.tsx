    ...
    <main className="bg-white pb-20 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <h1 className="text-2xl font-bold mb-6">
          My Cart{" "}
          {items.length > 0 && (
            <span className="text-gray-400 font-normal text-base">({items.length} items)</span>
          )}
        </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-8">
            ...
            <div className="h-fit border border-gray-100 rounded-2xl p-6 space-y-5 sticky top-28">
              ...
              <div className="space-y-3">
                <p className="text-xs text-gray-500">Do you have a promotional code?</p>
                <div className="flex gap-2">
                  <input
                    placeholder="Enter code"
                    className="flex-1 border border-gray-200 rounded-xl px-3 py-2.5 text-xs outline-none focus:border-black transition-colors"
                  />
                  <button className="bg-black text-white text-xs font-bold px-4 py-2.5 rounded-xl hover:opacity-80 transition-opacity">
                    Apply
                  </button>
                </div>
              </div>
              ...
              <Link href="/checkout">
                <button className="w-full bg-black text-white py-4 rounded-full text-sm font-bold hover:opacity-80 transition-opacity">
                  Checkout
                </button>
              </Link>
            </div>
